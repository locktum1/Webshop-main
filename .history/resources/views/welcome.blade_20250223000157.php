...
<body id="index">
    <div class="bg">
        ...
        <main>
            ...
            <x-product route="{{ route('product') }}" src="{{ asset('assets/Zoro2-Mousepad.png') }}" name="Zoro Mouse Pad" price="£19.99"></x-product>
            <x-product route="{{ route('product') }}" src="{{ asset('assets/DemonSlayer-Mousepad.png') }}" name="Zoro Mouse Pad" price="£19.99"></x-product>
