    ...
    <div class="bg">
        ...
        <main>
            ...
            <div id="signInOptions">
                <a href=""><div class=".signInOption" id="google"><img src="{{ asset("google.svg") }}" alt=""></div></a>
                <a href=""><div class=".signInOption" id="facebook"><img src="{{ asset("facebook.svg") }}" alt=""></div></a>
            </div>
        </main>
