...
@auth
    <div class="cart">
        <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="icon" id="right" href="#"><img src="{{ asset('assets/side-bar.svg') }}" alt="Log in or register"></a>
    </div>
@endauth
