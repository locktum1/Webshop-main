        ...
        @if (isset($product) && $product->count())
            <main id="main">
                <div class="product-image">
                    <img id="image" src="{{ asset("assets/{$product->img}") }}" alt="Demon slayer mousepad">
                </div>
                <div class="product-info">
                    ...
                    <div class="product-buttons">
                        ...
                        <div class="product-button" id="cart" data-id="1" data-name="{{ $product->name }}" data-price="{{ $product->price }}"><a href="javascript:void(0);">Add to cart</a></div>
