...
<body id="register">
    <div class="bg">
        ...
        <main>
            ...
            <form id="registerForm" action="{{ route("register.submit") }}" method="POST">
                ...
                <div id="registerFormContainer">
                    ...
                    <div class="registerInput">
                        ...
                        <input name="dob" type="date" placeholder="dd/mm/yyyy" value="{{ old('dob') }}" required>
                    </div>
            ...
            <h3 class="alternate-text">Already have an account? <a href="register" class="alternate-link">Log in</a></h3>
        </main>
